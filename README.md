...
- Семафор обеспечивает эксклюзивный доступ поезда к станции, то есть одновременно на станции может находиться только один поезд на одной платформе, на станции имеется две платформы (северная, южная).

### 3. Движение поездов
1. Поезд захватывает семафор станции, определенной платформы, при въезде на нее.
2. На одной станции имеется две станции, северная, южная. 
