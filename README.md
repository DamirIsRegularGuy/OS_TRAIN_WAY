...
### 3. Движение поездов
1. Поезд захватывает семафор станции перед въездом.  
...
```
## Анализ Вывода
Рассмотрим поезд номер 7 по маршруту Худжанд - Куляб (*Train 7 has route Khujand - Kulyab*), маршрут состоит из станций в 5 городах:
 - Худжанд
 - Истарафшан
 - Гафуров
 - Бустон
